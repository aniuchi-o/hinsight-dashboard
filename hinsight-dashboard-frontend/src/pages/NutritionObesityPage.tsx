...
const NutritionObesityPage = () => {
    ...
    const { data, isLoading, isError } = useDashboardData('nutrition-obesity');
    ...
    if (isError || !data) return <div className="p-6 text-sm text-rose-500">Unable to load nutrition and obesity data.</div>;
